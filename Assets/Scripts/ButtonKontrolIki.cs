...
public class ButtonKontrolIki : MonoBehaviour
{
   // GameObject ilkSezonCanvas;
    GameObject kayitDepo2;
    ...
    void Start()
    {
        ...
        kayitDepo2 = GameObject.FindGameObjectWithTag("KayitDepo2");
        buttonKontrol = GameObject.FindGameObjectWithTag("ButtonKontrol2");
        // jokerButton = GameObject.FindGameObjectWithTag("JokerButton").GetComponent<Button>();
        jokerUsed = GameObject.FindGameObjectWithTag("KayitDepo2").GetComponent<KayitIki>().jokerUsed;
    ...
    IEnumerator CevapEkraniDogru(Button button)
    {
        ...
        if (kayitDepo2.GetComponent<KayitIki>().jokerUsed == false) //sonraki scenler için aktif olmayabildiginden nerde bu diyor. Yoksa yoktur amk
        {
            jokerButton = GameObject.FindGameObjectWithTag("JokerButton").GetComponent<Button>();
    ...
    public void JokerButtonClick()
    {
        ...
        kayitDepo2.GetComponent<KayitIki>().JokerKullanildi();
        kayitDepo2.GetComponent<KayitIki>().JokerNerdeKullanildi(SceneManager.GetActiveScene().buildIndex - 1); //her sezon farklı bi ara bak
    ...
    void ButtonSerp()
    {
        ...
        {
            jokerButton = GameObject.FindGameObjectWithTag("JokerButton").GetComponent<Button>();
            jokerButton.GetComponent<Button>().onClick.AddListener(buttonKontrol.GetComponent<ButtonKontrolIki>().JokerButtonClick);
        }

        buttonA.GetComponent<Button>().onClick.AddListener(buttonKontrol.GetComponent<ButtonKontrolIki>().ButtonAclick);
        buttonB.GetComponent<Button>().onClick.AddListener(buttonKontrol.GetComponent<ButtonKontrolIki>().ButtonBclick);
        buttonC.GetComponent<Button>().onClick.AddListener(buttonKontrol.GetComponent<ButtonKontrolIki>().ButtonCclick);
        buttonD.GetComponent<Button>().onClick.AddListener(buttonKontrol.GetComponent<ButtonKontrolIki>().ButtonDclick);
    ...
    void SoruSerp()
    {
        ...
        cevapD.GetComponent<Text>().gameObject.SetActive(true);
        kayitDepo2 = GameObject.FindGameObjectWithTag("KayitDepo2");
        sorular = kayitDepo2.GetComponent<KayitIki>().SoruCek();
        cevaplar = kayitDepo2.GetComponent<KayitIki>().CevapCek();
        //  dogruCevap = kayitDepo.GetComponent<Kayit>().dogruCevap;

        dogruCevapMap = kayitDepo2.GetComponent<KayitIki>().dogruCevapMapiVer();
        soruDuzeniMap = kayitDepo2.GetComponent<KayitIki>().soruDuzeniMapiVer();
        ...
        kayitDepo2.GetComponent<KayitIki>().SoruSil(randomSoru);
    }
