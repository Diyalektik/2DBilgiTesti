...
public class SezonArasiKontrolIki : MonoBehaviour {
    ...
    void Start () {
        ...
        if (kayitDepo.GetComponent<KayitIki>().jokerUsed == false)
        {
        ...
        sezonArasiText.text = kayitDepo.GetComponent<KayitIki>().RaporVer();
    }
    ...
    void TemaRengiDegistir()
    {
        ...
        if (kayitDepo.GetComponent<KayitIki>().jokerUsed == false)
        {
            ...
            jokerText.color = Color.blue;
        }

        image.GetComponent<Image>().color = Color.blue;
        soruText.color = Color.blue;
        cevapA.color = Color.blue;
        cevapB.color = Color.blue;
        cevapC.color = Color.blue;
        cevapD.color = Color.blue;
